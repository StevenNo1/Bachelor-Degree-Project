<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="男生衣著.aspx.cs" Inherits="SelectThings" %>
...
<td runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Anotherconnection %>" SelectCommand="SELECT [pNo], [account], [picture], [category], [pName], [price], [stock], [Introduction], [createTime] FROM [Product] WHERE ((category='男生衣著')AND([justFor]='')AND([stock]>'0'))">
        </asp:SqlDataSource>
    </div>
    <div>
