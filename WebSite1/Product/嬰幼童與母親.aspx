<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="嬰幼童與母親.aspx.cs" Inherits="SelectThings" %>
...
<td runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Anotherconnection %>" SelectCommand="SELECT [pNo], [account], [picture], [category], [pName], [price], [stock], [Introduction], [createTime] FROM [Product] WHERE ((category='嬰幼童與母親')AND([justFor]='')AND([stock]>'0'))">
        </asp:SqlDataSource>
    </div>
    <div>
