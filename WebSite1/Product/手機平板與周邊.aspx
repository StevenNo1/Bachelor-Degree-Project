<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="手機平板與周邊.aspx.cs" Inherits="SelectThings" %>
...
<td runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Anotherconnection %>" SelectCommand="SELECT [pNo], [account], [picture], [category], [pName], [price], [stock], [Introduction], [createTime] FROM [Product] WHERE ((category='手機平板與周邊')AND([justFor]='')AND([stock]>'0'))">
        </asp:SqlDataSource>
    </div>
    <div>
